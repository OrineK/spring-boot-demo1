...
public class ResultMsg {
	 ...
	 * 图片尺寸
	 */
	public static final String UPLOAD_PIC_SIZE_ERROR="图片太大";
	 ...
	 * 两次密码输入不一致
	 */
	public static final String USERNAME_PASSWORD_NOEQUAL = "两次密码输入不一致";
	/**
	 * 用户已冻结，请联系管理员
	 */
	 ...
	 * 用户信息为空
	 */
	public static final String SESSION_USER_EMPTY = "用户信息不存在";
